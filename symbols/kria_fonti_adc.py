...
INPUTFOLDER = 'svg'
OUTPUTFILENAME = 'IosevkaSezimalSymbols.ttf'
PLACEHOLDERGEOMETRYSVG = 'svg/25A1.svg'

font = fontforge.font()
font.fontname = "Iosevka-Sezimal"
font.familyname = "Iosevka Sezimal Symbols"
font.fullname = font.familyname
font.copyright = "Public Domain 2025 by Ari Caldeira" #eg Copyright (c) 2022 Name
font.version = "1.0"
font.em = 1000
font.ascent = 800
font.descent = 200
...
SVGHEIGHT = 2048 # units of height of source svg viewbox.
...
def importAndCleanOutlines(outlinefile,glyph):
    ...
    for contour in foregroundlayer:
        for point in contour:
            point.transform((1,0,0,1,0, font.ascent * -1)) # Translate top of glyph down to baseline.
